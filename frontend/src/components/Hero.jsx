...
const Hero = () => {
  ...
  return (
    <section
      ...
      style={{
        backgroundImage: "url('/fallback.jpg')", // fallback image
    ...
    >
      ...
      {/* Content */}
      <div
        className="relative container mx-auto px-6 py-20 md:py-32 lg:py-40 flex flex-col items-start max-w-4xl"
        style={{
          transform: `translateY(${offsetY * 0.2}px)`,
          opacity: 1 - offsetY * 0.002, // fade out on scroll
      ...
      >
        ...
        >
          <div className="flex flex-col items-center">
            <span className="text-3xl md:text-4xl mb-2 hover:scale-110 transition-transform duration-300 cursor-pointer">
              🚗
            </span>
